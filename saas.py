...
settings_group.add_argument('--base-domain', dest='base_domain', help='Base domain. Used for system that work with --db-filter=%d', default='citymine.xyz')
...
portal_group.add_argument('--portal-db-name', dest='portal_db_name', default='saas-portal.citymine.xyz')
...
server_group.add_argument('--server-db-name', dest='server_db_name', default='server.citymine.xyz')
...
plan_group.add_argument('--plan-template-db-name', dest='plan_template_db_name', default='template.citymine.xyz')
plan_group.add_argument('--plan-clients', dest='plan_clients', default='client-%i.saas-portal.citymine.xyz', help='Template for new client databases')
...
def rpc_auth(dbname, admin_username='admin', admin_password='admin'):
    main_url = 'http://citymine.xyz:%s' % xmlrpc_port
    if args.get('simulate'):
